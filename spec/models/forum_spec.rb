...
describe Forum do
  ...
  context "composite" do
    ...
    it "single level" do
      @post1 = FactoryGirl.create(:forum_post, :forum => @forum, :created_at => Time.now - 3.days)
      ...
      @comment2 = FactoryGirl.create(:comment, :post => @post1, :created_at => Time.now - 1.day)
      @comment3 = FactoryGirl.create(:comment, :post => @post2, :created_at => Time.now)
      @comment4 = FactoryGirl.create(:comment, :post => @post2, :created_at => Time.now - 5.days)
